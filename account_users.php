        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">PETWORLD</a>
            ...
            <div class="container-fluid dashboard-content"> 
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $select = "SELECT * FROM petsworld_user_registrations where users_id = $users_id";
                        $query = mysqli_query($conn, $select);
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            $select = "SELECT * FROM petsworld_orders where users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            // $select = "SELECT * petsworld_orders_detail";
                                            $select = "SELECT petsworld_orders_detail.*, petsworld_orders.orders_id FROM petsworld_orders_detail JOIN petsworld_orders ON petsworld_orders_detail.orders_id = petsworld_orders.orders_id WHERE users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
