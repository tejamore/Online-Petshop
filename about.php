        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">PETSWORLD</a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            $select = "SELECT * FROM petsworld_category";
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    <h1></h1>
                                    <h3>We are a family-owned dog training and supplies company dedicated to providing and supplying dog items like Tre Ponti Dog Harnesses, Cricket Dog Treats, Doggie Chicken Chips, and DogSheetz just to name a few. We have been in the business of providing quality dog-related products ever since we started back in 2013.<center> Being in the business for several years now, we are proud to say that we are a company known to grant high-quality dog-related products as well as dog-training services.</center><h3>
                                </div>
                    		</div>
                    	</div>
                    </div>
