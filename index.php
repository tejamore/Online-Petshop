            ...
            <div class="container-fluid dashboard-content">    
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner rounded">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="uploads/tejas3.jpg" alt="First slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/kbpisr.jpg" alt="Second slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/tm.jpg" alt="Third slide">
                                    <div class="carousel-caption d-md-block pb-5">
                ...
                <div class="row m-5 hero-image2 rounded">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3 hero-text">
                        ...
                        <p class="text-dark px-5">A world-class editorial team of pet experts and authors</p>
                        <p class="text-dark px-5">Our dedicated team of authors and experts are here to provide you with pet information that you can depend on.
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2022 Concept. All rights reserved.</a>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
